...
function loadOperations()
{
	...
	$.getJSON("../../../mpa/api/rest/homebank/v1.2/accounts/"+accountId+"/operations", function(msg)
	{
		...
		//operations += '  </div>';
		operations += '  <div class="col-md-7 col-xs-12">';
		...
		operations += '	 <input type="text" width="100%" class="full" tabindex="1" placeholder="Montant" id="mpaOperationAmount"></input>';
		operations += ' </div>';
		...
		operations += ' <div class="col-md-4 col-xs-12">';
