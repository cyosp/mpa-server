...
function htmlAddAccount( accountId , accountVersion , accountName , accountAmount )
{
	...
	if( isAdmin )
	{
		...
		accounts += '<div class="col-md-1 col-xs-2">' + accountAmount + '&nbsp;' + moneySymbol + '</div>';
	...
	{
		accounts += '<div class="col-md-11 col-xs-8" id="' + accountId + '_accountName"></div>';
		accounts += '<div class="col-md-11 col-xs-8" id="' + accountId + '_accountNameNew" style="display:none"><input class="form-control"></input></div>';
		...
		accounts += '<div class="col-md-1 col-xs-4">' + accountAmount + '&nbsp;' + moneySymbol + '</div>';
	}
	...
	accountVar.html( "<a href='../operations/" + tokenQueryString + "&accountId=" + accountId + "&accountName=" + accountName + "'>" + accountVar.text() + "</a>" );
...
function restAddAccount()
{
	...
	}).done(function(data)
	{
		...
		{
			htmlAddAccount( response.id , response.version , accountName , response.balance );
			// Clear input field
			$("#mpaAccountName").val('');
		}
	}).fail(function() {
...
function loadCategories()
{
	...
	$.getJSON("../res/accounts/" + accountId + "/categories" + tokenQueryString, function(msg)
	{
		if( msg.isAdmin == "true" )
		{
			isAdmin = true;
		...
		$.each(msg.categories, function(index, category)
		{
			htmlAddCategory( category.id , category.version , category.name , category.amount );
		});
	});
}
...
function htmlAddCategory( categoryId , categoryVersion , categoryName , categoryAmount )
{
	...
	if( isAdmin )
	{
		...
		categories += '<div class="col-md-1 col-xs-2">' + categoryAmount + '&nbsp;' + moneySymbol + '</div>';
		
		categories += '<div class="col-md-1 col-xs-12"><button class="del full">-</button></div>';
	}
	else
	{
		categories += '<div class="col-md-11 col-xs-10" id="' + categoryId + '_categoryName"></div>';
		categories += '<div class="col-md-11 col-xs-10" id="' + categoryId + '_categoryNameNew" style="display:none"><input class="form-control"></input></div>';
		categories += '<div class="col-md-1 col-xs-2">' + categoryAmount + '&nbsp;' + moneySymbol + '</div>';
	}
	categories += '</div>';
...
function loadProviders()
{
	...
	// Load categorie from REST server
	$.getJSON("../res/accounts/" + accountId + "/providers" + tokenQueryString, function(msg)
	{
		if( msg.isAdmin == "true" )
		{
			isAdmin = true;
		...
		$.each(msg.providers, function(index, provider)
		{
			htmlAddProvider( provider.id , provider.version , provider.name , provider.amount );
		});
	});
}
...
function htmlAddProvider( providerId , providerVersion , providerName , providerAmount )
{
	...
	if( isAdmin )
	{
		...
		providers += '<div class="col-md-1 col-xs-2">' + providerAmount + '&nbsp;' + moneySymbol + '</div>';
		
		providers += '<div class="col-md-1 col-xs-12"><button class="del full">-</button></div>';
	}
	else
	{
		providers += '<div class="col-md-11 col-xs-10" id="' + providerId + '_providerName"></div>';
		providers += '<div class="col-md-11 col-xs-10" id="' + providerId + '_providerNameNew" style="display:none"><input class="form-control"></input></div>';
		providers += '<div class="col-md-1 col-xs-2">' + providerAmount + '&nbsp;' + moneySymbol + '</div>';
	}
	providers += '</div>';

	// Insert in DOM
	if( $("#mpaProviders div.row").length == 0 )	$("#mpaProviders").html(providers);
	else	$(providers).insertAfter($("#mpaProviders div.row:last"));
	...
	// Add color one line on two
	var lastRow = $("#mpaProviders div.row:last");
	if( $("#mpaProviders div.row").length % 2 === 0 )	lastRow.addClass( "odd" );
	else	lastRow.addClass( "peer" );
...
function loadOperations()
{
	...
	$.getJSON("../res/accounts/" + accountId + "/operations" + tokenQueryString, function(msg)
	{
		...
		operations += '	 <input type="text" width="100%" class="full" tabindex="1" name="provider" placeholder="Tiers" id="mpaOperationProvider"></input>';
		operations += ' </div>';
		
		operations += ' <div class="col-md-6 col-xs-12">';
		operations += '  <div class="col-md-4 col-xs-8">';
		operations += '	   <input type="text" width="100%" class="full mpaSubOpCat" tabindex="1" name="category1" placeholder="Catégorie" id="mpaOperationCategory" count="1"></input>';
		operations += '  </div>';
		operations += '  <div class="col-md-2 col-xs-4">';
		operations += '	  <input type="text" width="100%" class="full" tabindex="1" name="amount" placeholder="Montant" id="mpaOperationAmount"></input>';
		//operations += '	  <button name="e" id="mpaSubOpAddButton" class="full">+</button>';
		operations += '  </div>';
		operations += '  <div class="col-md-6 col-xs-12">';
		operations += '	  <input type="text" width="100%" class="full" tabindex="1" name="note" placeholder="Note" id="mpaOperationNote"></input>';
		operations += '  </div>';
		...
		operations += '	 <input type="text" width="100%" class="full" disabled="true" placeholder="Montant" id="mpaOperationAmount"></input>';
		operations += ' </div>';
		...
		operations += ' <div class="col-md-1 col-xs-12">';
		operations += '	 <label>Date</lablel>';
		operations += ' </div>';
		
		operations += ' <div class="col-md-1 col-xs-6">';
		operations += '	 <label>Tiers</lablel>';
		operations += ' </div>';
		
		operations += ' <div class="col-md-2 col-xs-8">';
		operations += '	 <label>Categorie</lablel>';
		operations += ' </div>';
		
		operations += ' <div class="col-md-1 col-xs-4">';
		operations += '	 <label>Montant</lablel>';
		operations += ' </div>';
		
		operations += ' <div class="col-md-3 col-xs-12">';
		operations += '	 <label>Note</lablel>';
		operations += ' </div>';
		...
		// Add calendar
		//$("#mpaOperationDivDate").datetimepicker();
...
/*
		...
		$.each(msg.operations, function(index, operation)
		{
...
function htmlAddOperation( operation )
{
	...
	var operationProvider = operation.provider;
	var operationAmount = operation.amount;
	var operationAccountBalance = operation.accountBalance;
	
	
	var operations = '<div class="row" id="' + operationId + '" version="' + operationVersion + '">';
	operations += '<div class="col-md-1 col-xs-12" id="' + operationId + '_operationDate"> ' + operationDate + '</div>';
	operations += '<div class="col-md-1 col-xs-6" id="' + operationId + '_operationProvider"> ' + operationProvider + '</div>';
	
	operations += '<div class="col-md-2 col-xs-8">';
	$.each(operation.subOperations, function(index, subOperation)
	{
		operations += '<div id="' + operationId + '_operationCategory"> ' + subOperation.category + '</div>';
	});
	operations += '</div>';
	...
	$.each(operation.subOperations, function(index, subOperation)
	{
		...
		operations += '<div class=' + opAmountSignClass + ' id="' + operationId + '_operationAmount"> ' + subOperation.amount + '</div>';
	});
	operations += '</div>';
	...
	$.each(operation.subOperations, function(index, subOperation)
	{
		operations += '<div id="' + operationId + '_operationNote"> ' + subOperation.note + '</div>';
	...
	var opAmountSignClass = '';
	if( operationAmount < 0 ) opAmountSignClass = 'amountNegativeSign';
	operations += '<div class="col-md-1 col-xs-6 ' + opAmountSignClass + '" id="' + operationId + '_operationAmount">' + operationAmount + '&nbsp;' + moneySymbol + '</div>';
	
	var operationAcountBalanceClass = '';
	if( operationAccountBalance < 0 ) operationAcountBalanceClass = 'amountNegativeSign';
	operations += '<div class="col-md-1 col-xs-6 ' + operationAcountBalanceClass + '" id="' + operationId + '_operationAccountBalance">' + operationAccountBalance + '&nbsp;' + moneySymbol + '</div>';
...
function restAddOperation()
{
	...
	// Get operation date
	var operationDate =  $("#mpaOperationDate").val();
	...
	$.post('../res/accounts/' + accountId + '/operations/add', {
		date : operationDate,
