...
function loadOperations()
{
	...
	$.getJSON("../../../mpa/api/rest/homebank/v1.2/accounts/"+accountId+"/operations", function(msg)
	{
        ...
        operations += '	 <input type="text" width="100%" class="full" tabindex="1" name="paymode" placeholder="Mode" id="mpaOperationMode"></input>';
        operations += ' </div>';
...
function htmlAddOperation( operation )
{
	...
	var operationMode = operation.paymode;
    ...
    operations += '<div class="col-md-1 col-xs-12">';
    operations += '<div id="' + operationId + '_operationMode"> ' + operationMode + '</div>';
    operations += '</div>';
