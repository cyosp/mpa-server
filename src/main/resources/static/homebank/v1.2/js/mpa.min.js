...
function loadOperations()
{
	...
	$.getJSON("../../../mpa/api/rest/homebank/v1.2/accounts/"+accountId+"/operations", function(msg)
	{
		...
		operations += '	   <input type="text" width="100%" class="full mpaSubOpCat" tabindex="1" name="category1" placeholder="Category" id="mpaOperationCategory" count="1"></input>';
		operations += '  </div>';
		...
		operations += '	 <label>Payee</lablel>';
		operations += ' </div>';
		
		operations += ' <div class="col-md-2 col-xs-8">';
		operations += '	 <label>Category</lablel>';
		operations += ' </div>';
		...
		operations += '	 <label>Wording</lablel>';
		operations += ' </div>';
		
		operations += ' <div class="col-md-1 col-xs-6">';
		operations += '	 <label>Amount</lablel>';
		operations += ' </div>';
		
		operations += ' <div class="col-md-1 col-xs-6">';
		operations += '	 <label>Balance</label>';
		operations += ' </div>';
