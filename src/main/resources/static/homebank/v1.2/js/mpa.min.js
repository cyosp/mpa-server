...
function htmlAddAccount( accountId , accountVersion , accountName , accountAmount )
{
	...
	{
		accounts += '<div class="col-md-11 col-xs-10" id="' + accountId + '_accountName"></div>';
		accounts += '<div class="col-md-11 col-xs-10" id="' + accountId + '_accountNameNew" style="display:none"><input class="form-control"></input></div>';
