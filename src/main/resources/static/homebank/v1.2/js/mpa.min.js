...
function htmlAddOperation( operation )
{
	...
	var operationProvider = operation.payeeName;
	...
	operations += '<div class="col-md-2 col-xs-8">';
	operations += '<div id="' + operationId + '_operationCategory"> ' + operation.categoryName + '</div>';
	operations += '</div>';
	...
	operations += '<div class="col-md-3 col-xs-12">';
	operations += '<div id="' + operationId + '_operationNote"> ' + operation.wording + '</div>';
	operations += '</div>';
