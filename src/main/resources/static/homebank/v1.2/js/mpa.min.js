...
function htmlAddAccount( accountId , accountVersion , accountName , accountAmount )
{
	...
	else
	{
		...
		accounts += '<div class="col-md-1 col-xs-5" style="text-align:right">' + accountAmount + '</div>';
	}
...
function htmlAddOperation( operation )
{
	...
	var opAmountSignClass = '';
	if( operationAmount < 0 ) opAmountSignClass = 'amountNegativeSign';
	operations += '<div class="col-md-1 col-xs-6 ' + opAmountSignClass + '" id="' + operationId + '_operationAmount">' + operationAmount + '</div>';
	
	var operationAcountBalanceClass = '';
	if( operationAccountBalance < 0 ) operationAcountBalanceClass = 'amountNegativeSign';
	operations += '<div class="col-md-1 col-xs-6 ' + operationAcountBalanceClass + '" id="' + operationId + '_operationAccountBalance">' + operationAccountBalance + '</div>';
